...
Test Case:           <xsl:value-of select="TestReportDocument/testcase"/>
Testbed:             <xsl:value-of select="TestReportDocument/testbed"/>
Parameter file:      <xsl:value-of select="TestReportDocument/parametersFile"/>
